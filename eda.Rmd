...
met21_23_sub = subset(met21_23, select = -c(wind_speed, wind_direction, wind_gust, humidity,
                                            visibility, time))
wl_21_23_sub = subset(wl_21_23, select = -c(inf))
```
...
Water Level: Apply a one-to-many mapping with the coral table. Each monthly water level measurement will be represented 6 times per day per month.
